...
DB_HOST = 'mynewsdb.cdywgwg6et80.ap-south-1.rds.amazonaws.com'
DB_PORT = '5432'
DB_NAME = 'postgres'
DB_USER = 'postgres'
DB_PASSWORD = 'ajmal6803'
...
def highlight_sentiment(row):
    if row['sentimental'] == 'positive':
        ...
        return ['background-color: black' if col == 'sentimental' else '' for col in row.index]
    else:
